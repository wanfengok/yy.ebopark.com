...
function updateView(parkTemp){
    ...
    for(var i=0;i<parkTemp.length;i++){
        var park=parkTemp[i];
        $(".parklist_ul").append('<li class="normalLi" style="padding:0px 22px;"><img src="'+IMG_URL+'/parking_icon.png" style="margin-right:10px;"/><div class="li_parkname"><p class="li_parkname">'+park.parkname+'</p><p class="li_parknamesec">'+park.address+'</p></div></li>');
    }
